            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data"><!--multipart/form-data berfungsi supaya file dapat diambil -->
                <div class="form-group">
                  <label for="idmakanan">Id</label>
                  <input type="text" name="id_makanan" class="form-control" id="idmakanan" aria-describedby="makanan" placeholder="Id Anggota">
               
                  <label for="namamakanan">Username</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Username">

                  <label for="namamakanan">Password</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Password">
