    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <h4>Rolade Jamur Tiram</h4>
            <p class="text-muted">Jamur Crispy</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <h4>Lumpia Jamur Tiram</h4>
            <p class="text-muted">Lumpia Jamur Tiram adalah</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <h4>Kerupuk Jamur Tiram</h4>
            <p class="text-muted">Kerupuk Jamur Tiram adalah</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <h4>Nugget Jamur Tiram</h4>
            <p class="text-muted">Nugget Jamur Tiram adalah</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/portfolio/07-thumbnail.jpg')?>" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Sate Jamur Tiram</h4>
            <p class="text-muted">Sate Jamur Tiram adalah</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/portfolio/08-thumbnail.jpg')?>" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Kentucky Jamur Tiram</h4>
            <p class="text-muted">Kentucky Jamur Tiram adalah</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/portfolio/09-thumbnail.jpg')?>" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Crispy Jamur Tiram</h4>
            <p class="text-muted">Crispy Jamur Tiram adalah</p>
          </div>
        </div>
      </div>
    </div>
