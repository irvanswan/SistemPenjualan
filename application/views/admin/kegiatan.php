            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data"><!--multipart/form-data berfungsi supaya file dapat diambil -->
                <div class="form-group">
                  ...
                  <input type="text" name="id_makanan" class="form-control" id="idmakanan" aria-describedby="makanan" placeholder="Id Kegiatan">
               
                  <label for="namamakanan">Nama Kegiatan</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Nama Kegiatan">

                  <label for="namamakanan">Deskripsi</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Deskripsi">

                  <label for="namamakanan">Tanggal Kegiatan</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Tanggal Kegiatan">

                  <label for="namamakanan">Tanggal Posting</label>
                  <input type="text" name="nama_makanan" class="form-control" id="namamakanan" placeholder="Tanggal Posting">
